...
//       // Automatically submit the exam when the tab is hidden
//       clearInterval(intervalId);
//       setTimeUp(true);
//     }
//   };
...
//                     isCorrect ? "bg-success" : "bg-error"
//                   }`}
//                   key={index} // Don't forget to add the key prop here
//                 >
//                   <h1 className="text-xl">
//                     {index + 1} : {question.name}
//                   </h1>
    ...
    if (document.visibilityState === "hidden") {
      setSwitchCount((prevCount) => {
        ...
        if (newCount === 1) {
          ...
          alert(
            "Your exam will submit if you try to switch tabs or leave the page again."
          );
        } else if (newCount > 1) {
